(function () {
  ...
  class Arvore {
    constructor(pos) {
      ...
      document.getElementsByClassName("vidas")[0].appendChild(this.element);
    }
  }
  ...
  class Placar {
    constructor() {
      ...
      document.getElementsByClassName("superior")[0].appendChild(this.element);
    }
    pontuar(qntd) {
      this.pontos += qntd;
  ...
  class Reserva {
    constructor () {
      ...
      document.getElementsByClassName("jogo")[0].appendChild(this.element);
    }
  }
  ...
  class Incendio {
    constructor (tipo) {
      ...
      this.element.onclick = (() => {
        if (!paused) {
          placar.pontuar(10);
          document.getElementsByClassName("jogo")[0].removeChild(this.element);
      ...
      this.devastar = (() => {
        ...
        if (arvores.length > this.arvores) {
          for (let i = 0; i < this.arvores; i++) document.getElementsByClassName("vidas")[0].removeChild(arvores.pop().element);
        } else {
          while (arvores.length > 0) document.getElementsByClassName("vidas")[0].removeChild(arvores.pop().element);
          if (!paused) GameOver();
        }
      }).bind(this);
  ...
  function resetGlobals() {
    ...
    focos.length = 0;
    arvores.length = 0;
    document.getElementsByClassName("vigilantes")[0].innerHTML = "<div class=\"superior\"><div class=\"vidas\"></div></div><div class=\"jogo\"></div>";
  }
